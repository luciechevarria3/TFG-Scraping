...
const chromeChild = exec('node ./chromeScraper/chromeScraper.js 3000',
...
const edgeChild = exec('node ./edgeScraper/edgeScraper.js 3000',
function (error, stdout, stderr) {
  console.log('\n stdout: ' + stdout);
  console.log('\n stderr: ' + stderr);
  if (error !== null) {
...
const firefoxChild = exec('node ./firefoxScraper/firefoxScraper.js 3000',
function (error, stdout, stderr) {
  console.log('\n stdout: ' + stdout);
  console.log('\n stderr: ' + stderr);
  if (error !== null) {
